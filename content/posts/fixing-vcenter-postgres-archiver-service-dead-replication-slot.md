...
Description: "After a homelab crash, the VCSA file-based backup isn't working anymore. In this post I'm describing how I was able to get the VMware Postgres Archiver service back in operating state by interfere with vCenters vPostgres instance."
